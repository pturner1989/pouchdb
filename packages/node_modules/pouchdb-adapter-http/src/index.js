...
function HttpPouch(opts, callback) {
  ...
  api.getAttachment = adapterFun('getAttachment', function (docId, attachmentId,
    ...
    ourFetch(url, { method: 'GET' }).then(function (response) {
      ...
      contentLength = parseInt(response.headers.get('content-length') || -1);
      ...
      //Check the data length matches the Content-Length header
      dataLength = blob.size || blob.length || 0;
      if (contentLength !== dataLength) {
        throw createError(INVALID_ATT, { expected: contentLength, recieved: dataLength })
      }
